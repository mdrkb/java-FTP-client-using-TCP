               ...
               if(flag==0){         // Write to Server
                   if(auth==0 && reply==1){
                       ...
                       if(cmd.contains("copy")){
                            ...
                            String workingDir = System.getProperty("user.dir")+"\\src\\Client1\\filelist.txt";
                   ...
                   if(!input.contains("cmd") && !input.contains("0") && !input.contains("1") && !input.contains("cpy")){
                       System.out.println(input);
                        ...
                        if(input.matches("1")){
                            ...
                            String fpart = values[0];
                            String lpart = values[1].replaceAll("cmd", "").trim();
                            String currentLine, totalLine = "";
                            BufferedReader inFromFile = new BufferedReader(new FileReader(workingDir));
                            ...
                            if(totalLine.contains(lpart)){
                                String path = System.getProperty("user.dir")+"\\src\\Client1\\"+lpart;
                            ...
                            String path = System.getProperty("user.dir")+"\\src\\Client1\\"+Client.file_name;
