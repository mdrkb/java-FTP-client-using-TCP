                   ...
                   if(auth==0 && reply==1){
                       ...
                       if(cmd.contains("copy")){
                           String values[] = cmd.split(" ");
                            ...
                            String workingDir = System.getProperty("user.dir")+"\\src\\Client2\\filelist.txt";
                   ...
                   if(!input.contains("cmd") && !input.contains("0") && !input.contains("1") && !input.contains("cpy")){
                       System.out.println(input);
                        ...
                        if(input.matches("1")){
                            ...
                            if(totalLine.contains(lpart)){
                                String path = System.getProperty("user.dir")+"\\src\\Client2\\"+lpart;
                            ...
                            String path = System.getProperty("user.dir")+"\\src\\Client2\\"+Client.file_name;
